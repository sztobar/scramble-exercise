(defproject scramble "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                :figwheel {:on-jsload "scramble.system/reset"}

                :compiler {:main cljs.user
                           :asset-path "js/compiled/out"
                           :output-to "dev-target/public/js/compiled/scramble.js"
               ...
               {:id "test"
                ...
                :compiler {:output-to "dev-target/public/js/compiled/testable.js"
                           :main scramble.test-runner
                           :optimizations :none}}

               {:id "min"
                :source-paths ["src/cljs" "src/cljc"]
                :jar true
                :compiler {:main scramble.system
